...
public class UpdateAnimal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Animal user = userService.getAnimalById(Long.parseLong(id));
        ...
        if (user != null ) {
                ...
                userService.updateAnimal(user);
                
                request.setAttribute("id", ownerId);
                request.getRequestDispatcher("/recClients.jsp").forward(request, response);
            }
        }
    }
