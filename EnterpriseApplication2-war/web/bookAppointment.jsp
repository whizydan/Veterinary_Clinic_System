...
<div class="content">
    <c:if test="${not empty animal}">
        <form method="post" action="ProcessBooking?id=<%=request.getParameter("id") %>">
<div class="card">
<div class="card-body">
<div class="row">
...
<label>Name</label>
<input value="${animal.name}" type="text" required name="name" minlength="3">
</div>
</div>
<div class="col-lg-3 col-sm-6 col-12">
<div class="form-group">
<label>Age</label>
<input value="${animal.age}" type="text" name="age" required>
</div>
</div>
<div class="col-lg-3 col-sm-6 col-12">
<div class="form-group">
<label>Condition</label>
<input value="${animal.condition}" type="text" name="condition" required>
</div>
</div>
<div class="col-lg-3 col-sm-6 col-12">
<div class="form-group">
...
<input required type="text" placeholder="DD-MM-YYYY" name="date" class="datetimepicker">
<div class="addonset">
...
<div class="form-group">
<label>Vet</label>
<select required class="select" name="vet">
    <c:forEach var="vet" items="${requestScope.vet}">
        <option value="${vet.id}">${vet.name} Specialist in: ${vet.profession}</option>
    </c:forEach>
</select>
</div>
</div>
